...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_class=460):
        super().__init__()
...
# def vgg16(num_class=460):
#     return VGG(make_layers(cfg['D'], batch_norm=False),num_class=num_class)

def vgg16_bn(num_class=460):
    return VGG(make_layers(cfg['D'], batch_norm=True),num_class=num_class)

# def vgg19():
#     return VGG(make_layers(cfg['E'], batch_norm=False))

# def vgg19_bn(num_class=460):
